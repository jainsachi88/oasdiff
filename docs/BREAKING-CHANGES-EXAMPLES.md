...
[changing an additionalResponse property schema type from integer to string is breaking](../checker/check_response_property_type_changed_test.go?plain=1#L149)  
[changing an embedded additionalResponse property schema type from integer to string is breaking](../checker/check_response_property_type_changed_test.go?plain=1#L171)  
...
[changing request's query param property type from number to string is breaking](../checker/check_request_parameters_type_changed_test.go?plain=1#L207)  
...
[deprecating a property with a deprecation policy and sunset date before required deprecation period is breaking](../checker/check_request_property_deprecation_test.go?plain=1#L117)  
[deprecating a property with a deprecation policy but without specifying sunset date is breaking](../checker/check_request_property_deprecation_test.go?plain=1#L86)  
[deprecating a property with an invalid sunset date format is breaking](../checker/check_request_property_deprecation_test.go?plain=1#L181)  
[deprecating a response property with a deprecation policy and sunset date before required deprecation period is breaking](../checker/check_response_property_deprecation_test.go?plain=1#L113)  
[deprecating a response property with a deprecation policy but without specifying sunset date is breaking](../checker/check_response_property_deprecation_test.go?plain=1#L82)  
[deprecating a response property with an invalid sunset date format is breaking](../checker/check_response_property_deprecation_test.go?plain=1#L176)  
...
[deprecating an operation with invalid JSON sunset date is breaking](../checker/check_api_deprecation_test.go?plain=1#L380)  
...
[modifying a media type name in response to make it more general is breaking](../checker/check_response_mediatype_name_updated_test.go?plain=1#L41)  
...
[specializing request's query param property type from string to number is breaking](../checker/check_request_parameters_type_changed_test.go?plain=1#L224)  
...
[adding a required property to response is not breaking](../checker/check_not_breaking_test.go?plain=1#L291)  
[adding a tag is not breaking](../checker/check_not_breaking_test.go?plain=1#L268)  
...
[adding an operation ID is not breaking](../checker/check_not_breaking_test.go?plain=1#L279)  
...
[changing parameters of a media type is not breaking](../checker/check_response_mediatype_name_updated_test.go?plain=1#L11)  
...
[changing servers is not breaking](../checker/check_not_breaking_test.go?plain=1#L254)  
...
[deprecating a header is not breaking](../checker/check_not_breaking_test.go?plain=1#L228)  
[deprecating a parameter is not breaking](../checker/check_not_breaking_test.go?plain=1#L215)  
...
[deprecating a property with a deprecation policy and sunset date after required deprecation period is not breaking](../checker/check_request_property_deprecation_test.go?plain=1#L138)  
[deprecating a property without a deprecation policy and without specifying sunset date is not breaking for alpha level](../checker/check_request_property_deprecation_test.go?plain=1#L103)  
[deprecating a response property with a deprecation policy and sunset date after required deprecation period is not breaking](../checker/check_response_property_deprecation_test.go?plain=1#L133)  
[deprecating a response property without a deprecation policy and without specifying sunset date is not breaking for alpha level](../checker/check_response_property_deprecation_test.go?plain=1#L99)  
[deprecating a schema is not breaking](../checker/check_not_breaking_test.go?plain=1#L241)  
...
[changing a response property schema format](../checker/check_response_property_type_changed_test.go?plain=1#L59)  
[changing a response property schema type from a single value to to multiple types](../checker/check_response_property_type_changed_test.go?plain=1#L125)  
[changing a response property schema type from string to integer](../checker/check_response_property_type_changed_test.go?plain=1#L35)  
[changing a response schema type](../checker/check_response_property_type_changed_test.go?plain=1#L13)  
...
[changing discriminator mapping in the request body or request body property](../checker/check_request_discriminator_updated_test.go?plain=1#L112)  
[changing discriminator mapping in the response body or response property](../checker/check_response_discriminator_updated_test.go?plain=1#L114)  
[changing discriminator propertyName in the request body or request body property](../checker/check_request_discriminator_updated_test.go?plain=1#L78)  
[changing discriminator propertyName in the response body or response property](../checker/check_response_discriminator_updated_test.go?plain=1#L80)  
...
[changing properties of subschemas under allOf](../checker/check_response_property_type_changed_test.go?plain=1#L83)  
[changing request body and property types from array to object](../checker/check_request_property_type_changed_test.go?plain=1#L86)  
[changing request body and property types from object to array](../checker/check_request_property_type_changed_test.go?plain=1#L118)  
...
[changing request body type](../checker/check_request_property_type_changed_test.go?plain=1#L13)  
[changing request header parameter format](../checker/check_request_parameters_type_changed_test.go?plain=1#L133)  
[changing request header parameter type](../checker/check_request_parameters_type_changed_test.go?plain=1#L61)  
...
[changing request path parameter format](../checker/check_request_parameters_type_changed_test.go?plain=1#L85)  
[changing request path parameter type by adding "string"](../checker/check_request_parameters_type_changed_test.go?plain=1#L157)  
[changing request path parameter type by replacing "integer" with "number"](../checker/check_request_parameters_type_changed_test.go?plain=1#L182)  
[changing request path parameter type](../checker/check_request_parameters_type_changed_test.go?plain=1#L13)  
[changing request property default value](../checker/check_request_property_default_value_changed_test.go?plain=1#L34)  
[changing request property format](../checker/check_request_property_type_changed_test.go?plain=1#L150)  
...
[changing request property type](../checker/check_request_property_type_changed_test.go?plain=1#L63)  
[changing request query parameter format](../checker/check_request_parameters_type_changed_test.go?plain=1#L109)  
[changing request query parameter type](../checker/check_request_parameters_type_changed_test.go?plain=1#L37)  
...
[deprecating a request property with invalid stability level is skipped (handled in CheckBackwardCompatibility)](../checker/check_request_property_deprecation_test.go?plain=1#L197)  
[deprecating a response property with invalid stability level is skipped (handled in CheckBackwardCompatibility)](../checker/check_response_property_deprecation_test.go?plain=1#L192)  
[deprecating an operation with a sunset date in RFC3339 format is properly parsed](../checker/check_api_deprecation_test.go?plain=1#L355)  
[deprecating an operation with sunset greater than min](../checker/check_not_breaking_test.go?plain=1#L198)  
[detecting deprecated request properties in allOf schemas with multiple media types](../checker/check_request_property_deprecation_test.go?plain=1#L35)  
[detecting deprecated request properties with sunset date](../checker/check_request_property_deprecation_test.go?plain=1#L19)  
[detecting deprecated response properties in allOf schemas with multiple media types](../checker/check_response_property_deprecation_test.go?plain=1#L31)  
[detecting deprecated response properties with sunset date](../checker/check_response_property_deprecation_test.go?plain=1#L15)  
[each media type gets its own report with distinct details (issue #594)](../checker/check_request_property_deprecation_test.go?plain=1#L59)  
[endpoint deprecation message includes sunset date](../checker/check_api_deprecation_test.go?plain=1#L400)  
[generalizing pattern of request parameters](../checker/check_request_parameter_pattern_added_or_changed_test.go?plain=1#L37)  
[generalizing request property format](../checker/check_request_property_type_changed_test.go?plain=1#L175)  
[generalizing request property pattern](../checker/check_request_property_pattern_added_or_changed_test.go?plain=1#L37)  
[generalizing request's query param property type from integer to number](../checker/check_request_parameters_type_changed_test.go?plain=1#L241)  
...
[message has no details when endpoint deprecated without sunset or stability](../checker/check_api_deprecation_test.go?plain=1#L317)  
...
[message has no details when request property deprecated without sunset or stability](../checker/check_request_property_deprecation_test.go?plain=1#L215)  
[message has no details when response property deprecated without sunset or stability](../checker/check_response_property_deprecation_test.go?plain=1#L210)  
[message includes both sunset and stability when endpoint deprecated with both](../checker/check_api_deprecation_test.go?plain=1#L297)  
...
[message includes stability when endpoint deprecated with stability but no sunset](../checker/check_api_deprecation_test.go?plain=1#L336)  
...
[message includes sunset date when request property deprecated with valid sunset](../checker/check_request_property_deprecation_test.go?plain=1#L232)  
[message includes sunset date when response property deprecated with valid sunset](../checker/check_response_property_deprecation_test.go?plain=1#L227)  
[message includes sunset details when endpoint deprecated with sunset date](../checker/check_api_deprecation_test.go?plain=1#L277)  
...
[no changes when operations diff is nil](../checker/check_request_property_any_of_updated_test.go?plain=1#L90)  
[no changes when paths diff is nil](../checker/check_request_property_any_of_updated_test.go?plain=1#L80)  
[no changes when property is read-only](../checker/check_request_property_type_changed_test.go?plain=1#L279)  
[no changes when request body diff is nil](../checker/check_request_property_any_of_updated_test.go?plain=1#L106)  
[no changes when schema diff is nil](../checker/check_request_property_any_of_updated_test.go?plain=1#L128)  
...
[path operations that became deprecated](../checker/check_api_deprecation_test.go?plain=1#L205)  
[path operations that were re-activated](../checker/check_api_deprecation_test.go?plain=1#L232)  
[properties that were re-activated](../checker/check_request_property_deprecation_test.go?plain=1#L159)  
...
[removing a media type from response](../checker/check_response_mediatype_updated_test.go?plain=1#L34)  
...
[removing discriminator from the request body or request body property](../checker/check_request_discriminator_updated_test.go?plain=1#L45)  
[removing discriminator from the response body or response property](../checker/check_response_discriminator_updated_test.go?plain=1#L46)  
...
[response properties that were re-activated](../checker/check_response_property_deprecation_test.go?plain=1#L154)  
